...
export async function uploadAnswers(corrections: rimaCorrection[], gameSession: string, userEmail: string | null, userPassword: string | null, score: number, start_date: Date, db: Connection) {
